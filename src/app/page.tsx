		...
		<div className="min-h-screen bg-gray-50 flex items-center justify-center">
			<div className="text-center space-y-8 px-4">
				...
				<div className="flex flex-col sm:flex-row gap-4 justify-center">
					<Link
						href="/login"
						className="bg-purple-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-purple-600 transition-colors"
					>
						Iniciar Sesión
					</Link>
					<Link
						href="/registro"
						className="border-2 border-purple-500 text-purple-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-purple-500 hover:text-white transition-colors"
					>
						Registrarse
					</Link>
				</div>
